...
=item UrlAlias url-aliases_file
...
remove from log timestamp to adjust graphs times. For example:


	TimeZone       +01

will append one hour to all graphs time series to match squid server timestamp.
